<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Other.aspx.cs" Inherits="WebApplication4.Other" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var hot = new Handsontable(container, {
                ...
                minSpareRows: 1,
                colHeaders: ["Account Number", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
                columns: [
                  {
                      type: 'dropdown',
                      source: accounts
